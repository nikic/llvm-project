...
public:
  ...
  unsigned getSizeInBytes() const { return getSubclassData() & 0xff; }
...
private:
  ...
  static const unsigned HasSubsectionsViaSymbolsBit = 1 << 17;
...
private:
  ...
  MCUnaryExpr(Opcode Op, const MCExpr *Expr, SMLoc Loc)
      : MCExpr(MCExpr::Unary, Op, Loc), Expr(Expr) {}
...
private:
  ...
  MCBinaryExpr(Opcode Op, const MCExpr *LHS, const MCExpr *RHS,
               SMLoc Loc = SMLoc())
      : MCExpr(MCExpr::Binary, Op, Loc), LHS(LHS), RHS(RHS) {}
...
protected:
  MCTargetExpr() : MCExpr(Target, 0, SMLoc()) {}
