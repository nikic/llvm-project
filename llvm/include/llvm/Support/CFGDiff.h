...
public:
  ...
  VectRet getChildren (NodePtr N) const {
    using DirectedNodeT = std::conditional_t<InverseEdge, Inverse<NodePtr>, NodePtr>;
    ...
    UpdatedCFGChildren.insert(UpdatedCFGChildren.end(), AddedCFGChildren.begin(), AddedCFGChildren.end());
