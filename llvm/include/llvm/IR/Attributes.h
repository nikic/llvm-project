...
public:
  ...
  /// Return attribute with the given enum kind.
  Attribute getAttribute(Attribute::AttrKind A) const;

  /// Return attribute with the given string kind.
  Attribute getAttribute(StringRef A) const;
  ...
  /// Return true if the builder contains no atttributes.
