...
public:
  upward_defs_iterator(const UpwardDefsElem &Elem, DominatorTree *DT)
    ...
    CurrentElem.MayHaveLoopCarriedDependency =
        Elem.MayHaveLoopCarriedDependency;
