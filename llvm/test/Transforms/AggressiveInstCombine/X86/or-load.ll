...
; BE-NEXT:    [[TMP1:%.*]] = load i16, ptr [[P:%.*]], align 1
; BE-NEXT:    ret i16 [[TMP1]]
;
  %p1 = getelementptr i8, ptr %p, i32 1
  %l1 = load i8, ptr %p
  %l2 = load i8, ptr %p1
...
; LE-NEXT:    [[TMP1:%.*]] = load i64, ptr [[P]], align 4
; LE-NEXT:    [[TMP2:%.*]] = zext i64 [[TMP1]] to i128
...
; BE-NEXT:    [[P2:%.*]] = getelementptr i32, ptr [[P:%.*]], i32 2
; BE-NEXT:    [[P3:%.*]] = getelementptr i32, ptr [[P]], i32 3
; BE-NEXT:    [[TMP1:%.*]] = load i64, ptr [[P]], align 4
; BE-NEXT:    [[TMP2:%.*]] = zext i64 [[TMP1]] to i128
; BE-NEXT:    [[TMP3:%.*]] = shl i128 [[TMP2]], 64
; BE-NEXT:    [[L3:%.*]] = load i32, ptr [[P2]], align 4
; BE-NEXT:    [[L4:%.*]] = load i32, ptr [[P3]], align 4
; BE-NEXT:    [[E3:%.*]] = zext i32 [[L3]] to i128
; BE-NEXT:    [[E4:%.*]] = zext i32 [[L4]] to i128
; BE-NEXT:    [[S3:%.*]] = shl i128 [[E3]], 32
; BE-NEXT:    [[O2:%.*]] = or i128 [[TMP3]], [[S3]]
...
; LE-NEXT:    [[TMP1:%.*]] = load i64, ptr [[P:%.*]], align 2
; LE-NEXT:    ret i64 [[TMP1]]
;
...
; BE-NEXT:    [[TMP1:%.*]] = load i64, ptr [[P:%.*]], align 2
; BE-NEXT:    ret i64 [[TMP1]]
;
  %p1 = getelementptr i16, ptr %p, i32 1
  %p2 = getelementptr i16, ptr %p, i32 2
  %p3 = getelementptr i16, ptr %p, i32 3
...
; LE-NEXT:    [[TMP1:%.*]] = load i32, ptr [[P:%.*]], align 1, !alias.scope !0
