...
; FNATTRS-SAME: (ptr nocapture writeonly initialized((0,4)) [[PTR:%.*]]) #[[ATTR4:[0-9]+]] {
; FNATTRS-NEXT:  entry:
...
; FNATTRS-SAME: (ptr nocapture writeonly initialized((0,4)) [[PTR:%.*]]) #[[ATTR7:[0-9]+]] {
; FNATTRS-NEXT:  entry:
...
; FNATTRS-SAME: (ptr nocapture writeonly initialized((0,32)) [[DST:%.*]], ptr nocapture readonly [[SRC:%.*]]) #[[ATTR9:[0-9]+]] {
; FNATTRS-NEXT:  entry:
...
; FNATTRS-SAME: (ptr nocapture writeonly initialized((0,32)) [[DST:%.*]]) #[[ATTR11:[0-9]+]] {
; FNATTRS-NEXT:  entry:
...
; FNATTRS-SAME: (ptr nocapture writeonly initialized((0,4)) [[ARG:%.*]]) #[[ATTR15:[0-9]+]] {
