...
; CHECK-NEXT:    [[ADD_PTR_I1:%.*]] = load ptr, ptr [[S]], align 4, !tbaa [[ANYPTR_TBAA0:![0-9]+]]
; CHECK-NEXT:    store i32 [[I_05]], ptr [[ADD_PTR_I1]], align 4, !tbaa [[INT_TBAA5:![0-9]+]]
; CHECK-NEXT:    [[ADD_PTR_I:%.*]] = getelementptr inbounds i32, ptr [[ADD_PTR_I1]], i32 1
; CHECK-NEXT:    store ptr [[ADD_PTR_I]], ptr [[S]], align 4, !tbaa [[ANYPTR_TBAA7:![0-9]+]]
...
; CHECK: [[ANYPTR_TBAA7]] = !{[[META2]], [[META2]], i64 0}
;.
