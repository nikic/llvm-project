...
; CHECK-NEXT:    [[TMP32:%.*]] = getelementptr i32, ptr @ARR, i64 [[IDX_NEG]]
; CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr i8, ptr [[TMP32]], i64 396
...
; CHECK-NEXT:    [[TMP34:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_NEG]]
; CHECK-NEXT:    [[ADD_PTR_110:%.*]] = getelementptr i8, ptr [[TMP34]], i64 396
...
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_112_NEG]]
; CHECK-NEXT:    [[ADD_PTR_217:%.*]] = getelementptr i8, ptr [[TMP35]], i64 396
...
; CHECK-NEXT:    [[TMP37:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_219_NEG]]
; CHECK-NEXT:    [[ADD_PTR_3:%.*]] = getelementptr i8, ptr [[TMP37]], i64 396
...
; CHECK-NEXT:    [[TMP38:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_3_NEG]]
; CHECK-NEXT:    [[ADD_PTR_4:%.*]] = getelementptr i8, ptr [[TMP38]], i64 396
...
; CHECK-NEXT:    [[TMP39:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_4_NEG]]
; CHECK-NEXT:    [[ADD_PTR_5:%.*]] = getelementptr i8, ptr [[TMP39]], i64 396
...
; CHECK-NEXT:    [[TMP41:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_5_NEG]]
; CHECK-NEXT:    [[ADD_PTR_6:%.*]] = getelementptr i8, ptr [[TMP41]], i64 396
...
; CHECK-NEXT:    [[TMP43:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_6_NEG]]
; CHECK-NEXT:    [[ADD_PTR_7:%.*]] = getelementptr i8, ptr [[TMP43]], i64 396
...
; CHECK-NEXT:    [[TMP45:%.*]] = getelementptr i32, ptr @ARR, i64 [[IDX_NEG_1]]
; CHECK-NEXT:    [[ADD_PTR_1:%.*]] = getelementptr i8, ptr [[TMP45]], i64 396
; CHECK-NEXT:    [[TMP8:%.*]] = load i32, ptr [[ADD_PTR_1]], align 4, !tbaa [[TBAA3]]
; CHECK-NEXT:    [[INDVARS_IV_NEXT_1_NEG:%.*]] = xor i64 [[INDVARS_IV_1]], -1
; CHECK-NEXT:    [[TMP47:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_1_NEG]]
; CHECK-NEXT:    [[ADD_PTR_1_1:%.*]] = getelementptr i8, ptr [[TMP47]], i64 396
...
; CHECK-NEXT:    [[TMP49:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_1_1_NEG]]
; CHECK-NEXT:    [[ADD_PTR_1_2:%.*]] = getelementptr i8, ptr [[TMP49]], i64 396
...
; CHECK-NEXT:    [[TMP51:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_1_2_NEG]]
; CHECK-NEXT:    [[ADD_PTR_1_3:%.*]] = getelementptr i8, ptr [[TMP51]], i64 396
...
; CHECK-NEXT:    [[TMP53:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_1_3_NEG]]
; CHECK-NEXT:    [[ADD_PTR_1_4:%.*]] = getelementptr i8, ptr [[TMP53]], i64 396
...
; CHECK-NEXT:    [[TMP55:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_1_4_NEG]]
; CHECK-NEXT:    [[ADD_PTR_1_5:%.*]] = getelementptr i8, ptr [[TMP55]], i64 396
...
; CHECK-NEXT:    [[TMP33:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_1_5_NEG]]
; CHECK-NEXT:    [[ADD_PTR_1_6:%.*]] = getelementptr i8, ptr [[TMP33]], i64 396
...
; CHECK-NEXT:    [[TMP36:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_1_6_NEG]]
; CHECK-NEXT:    [[ADD_PTR_1_7:%.*]] = getelementptr i8, ptr [[TMP36]], i64 396
...
; CHECK-NEXT:    [[TMP40:%.*]] = getelementptr i32, ptr @ARR, i64 [[IDX_NEG_2]]
; CHECK-NEXT:    [[ADD_PTR_2:%.*]] = getelementptr i8, ptr [[TMP40]], i64 396
...
; CHECK-NEXT:    [[TMP42:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_2_NEG]]
; CHECK-NEXT:    [[ADD_PTR_2_1:%.*]] = getelementptr i8, ptr [[TMP42]], i64 396
...
; CHECK-NEXT:    [[TMP44:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_2_1_NEG]]
; CHECK-NEXT:    [[ADD_PTR_2_2:%.*]] = getelementptr i8, ptr [[TMP44]], i64 396
...
; CHECK-NEXT:    [[TMP46:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_2_2_NEG]]
; CHECK-NEXT:    [[ADD_PTR_2_3:%.*]] = getelementptr i8, ptr [[TMP46]], i64 396
...
; CHECK-NEXT:    [[TMP48:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_2_3_NEG]]
; CHECK-NEXT:    [[ADD_PTR_2_4:%.*]] = getelementptr i8, ptr [[TMP48]], i64 396
...
; CHECK-NEXT:    [[TMP50:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_2_4_NEG]]
; CHECK-NEXT:    [[ADD_PTR_2_5:%.*]] = getelementptr i8, ptr [[TMP50]], i64 396
...
; CHECK-NEXT:    [[TMP52:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_2_5_NEG]]
; CHECK-NEXT:    [[ADD_PTR_2_6:%.*]] = getelementptr i8, ptr [[TMP52]], i64 396
...
; CHECK-NEXT:    [[TMP54:%.*]] = getelementptr i32, ptr @ARR, i64 [[INDVARS_IV_NEXT_2_6_NEG]]
; CHECK-NEXT:    [[ADD_PTR_2_7:%.*]] = getelementptr i8, ptr [[TMP54]], i64 396
