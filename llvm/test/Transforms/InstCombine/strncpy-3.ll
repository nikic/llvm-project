...
; CHECK-NEXT:    store <4 x i8> <i8 97, i8 0, i8 0, i8 0>, ptr [[DST:%.*]], align 1
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    store <4 x i8> <i8 97, i8 98, i8 99, i8 0>, ptr [[DST:%.*]], align 1
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    store <4 x i8> <i8 97, i8 98, i8 99, i8 100>, ptr [[DST:%.*]], align 1
; CHECK-NEXT:    ret void
;
