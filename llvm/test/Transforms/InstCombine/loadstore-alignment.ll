...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x i64>, <2 x i64>* getelementptr (<2 x i64>, <2 x i64>* @x, i64 7), align 1
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x i64>, <2 x i64>* [[T]], align 1
; CHECK-NEXT:    ret <2 x i64> [[TMP1]]
;
...
define <2 x i64> @foo() {
; CHECK-LABEL: @foo(
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x i64>, <2 x i64>* @x, align 1
; CHECK-NEXT:    ret <2 x i64> [[TMP1]]
;
...
; CHECK-NEXT:    store <2 x i64> [[Y:%.*]], <2 x i64>* getelementptr (<2 x i64>, <2 x i64>* @x, i64 7), align 1
; CHECK-NEXT:    ret void
;
  %t = getelementptr <2 x i64>, <2 x i64>* @x, i32 7
...
; CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[I:%.*]] to i64
; CHECK-NEXT:    [[T:%.*]] = getelementptr <2 x i64>, <2 x i64>* @x, i64 [[TMP1]]
; CHECK-NEXT:    store <2 x i64> [[Y:%.*]], <2 x i64>* [[T]], align 1
; CHECK-NEXT:    ret void
;
  %t = getelementptr <2 x i64>, <2 x i64>* @x, i32 %i
  store <2 x i64> %y, <2 x i64>* %t, align 1
...
; CHECK-NEXT:    store <2 x i64> [[Y:%.*]], <2 x i64>* @x, align 1
; CHECK-NEXT:    ret void
;
