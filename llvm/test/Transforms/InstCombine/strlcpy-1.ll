...
; ANY-LABEL: @fold_strlcpy_s1(
; ANY-NEXT:    call void @sink(ptr [[DST:%.*]], i64 1)
; ANY-NEXT:    store i8 0, ptr [[DST]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 1)
...
; ANY-LABEL: @fold_strlcpy_s5(
; ANY-NEXT:    call void @sink(ptr [[DST:%.*]], i64 4)
; ANY-NEXT:    store i8 0, ptr [[DST]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 4)
; ANY-NEXT:    store i8 49, ptr [[DST]], align 1
; ANY-NEXT:    [[TMP1:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 1
; ANY-NEXT:    store i8 0, ptr [[TMP1]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 4)
; ANY-NEXT:    store <2 x i8> <i8 49, i8 50>, ptr [[DST]], align 1
; ANY-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 2
; ANY-NEXT:    store i8 0, ptr [[TMP2]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 4)
; ANY-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(3) [[DST]], ptr noundef nonnull align 1 dereferenceable(3) @s4, i64 3, i1 false)
; ANY-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 3
; ANY-NEXT:    store i8 0, ptr [[TMP3]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 4)
; ANY-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) [[DST]], ptr noundef nonnull align 1 dereferenceable(5) @s4, i64 5, i1 false)
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 4)
; ANY-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) [[DST]], ptr noundef nonnull align 1 dereferenceable(5) @s4, i64 5, i1 false)
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 4)
; ANY-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) [[DST]], ptr noundef nonnull align 1 dereferenceable(5) @s4, i64 5, i1 false)
...
; ANY-LABEL: @fold_strlcpy_a5(
; ANY-NEXT:    call void @sink(ptr [[DST:%.*]], i64 5)
; ANY-NEXT:    store i8 0, ptr [[DST]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 5)
; ANY-NEXT:    store i8 49, ptr [[DST]], align 1
; ANY-NEXT:    [[TMP1:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 1
; ANY-NEXT:    store i8 0, ptr [[TMP1]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 5)
; ANY-NEXT:    store <4 x i8> <i8 49, i8 50, i8 51, i8 52>, ptr [[DST]], align 1
; ANY-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 4
; ANY-NEXT:    store i8 0, ptr [[TMP2]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 5)
; ANY-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) [[DST]], ptr noundef nonnull align 1 dereferenceable(5) @a5, i64 5, i1 false)
; ANY-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 5
; ANY-NEXT:    store i8 0, ptr [[TMP3]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 5)
; ANY-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) [[DST]], ptr noundef nonnull align 1 dereferenceable(5) @a5, i64 5, i1 false)
; ANY-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 5
; ANY-NEXT:    store i8 0, ptr [[TMP4]], align 1
; ANY-NEXT:    call void @sink(ptr nonnull [[DST]], i64 5)
; ANY-NEXT:    ret void
;
