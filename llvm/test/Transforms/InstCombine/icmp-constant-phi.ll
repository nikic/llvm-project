...
; CHECK-NEXT:    br label [[MERGE]]
; CHECK:       merge:
; CHECK-NEXT:    [[PHI:%.*]] = phi float [ 1.250000e+00, [[IF_FALSE]] ], [ 1.000000e+00, [[IF_TRUE]] ]
; CHECK-NEXT:    br label [[EXIT:%.*]]
; CHECK:       exit:
...
; CHECK-NEXT:    br label [[MERGE]]
; CHECK:       merge:
; CHECK-NEXT:    [[PHI:%.*]] = phi <2 x float> [ <float 4.562500e+02, float 4.562500e+02>, [[IF_FALSE]] ], [ <float 1.232500e+02, float 1.232500e+02>, [[IF_TRUE]] ]
; CHECK-NEXT:    br label [[EXIT:%.*]]
; CHECK:       exit:
