...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x i8>, ptr [[S:%.*]], align 1
; CHECK-NEXT:    store <2 x i8> [[TMP1]], ptr [[D:%.*]], align 1
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <4 x i8>, ptr [[S:%.*]], align 1
; CHECK-NEXT:    store <4 x i8> [[TMP1]], ptr [[D:%.*]], align 1
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <8 x i8>, ptr [[S:%.*]], align 1
; CHECK-NEXT:    store <8 x i8> [[TMP1]], ptr [[D:%.*]], align 1
; CHECK-NEXT:    ret void
;
