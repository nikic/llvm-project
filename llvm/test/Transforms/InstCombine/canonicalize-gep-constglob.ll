...
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr i8, ptr [[TMP0]], i64 84
...
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr i8, ptr [[GEP]], i64 116
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[GEP_SPLIT:%.*]] = getelementptr [10 x [10 x [10 x i32]]], ptr @glob, i64 0, i64 [[X]], i64 1
...
; CHECK-SAME: i64 [[X:%.*]]) {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr [10 x i32], ptr @glob, i64 0, i64 [[X]]
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr i8, ptr [[TMP0]], i64 32
; CHECK-NEXT:    ret ptr [[GEP]]
;
entry:
...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr @glob, i64 [[GEP1_IDX]]
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr i8, ptr [[TMP0]], i64 134
; CHECK-NEXT:    [[GEP2_IDX:%.*]] = mul nsw i64 [[X]], 400
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr @glob, i64 [[GEP2_IDX]]
; CHECK-NEXT:    [[GEP2:%.*]] = getelementptr i8, ptr [[TMP1]], i64 132
