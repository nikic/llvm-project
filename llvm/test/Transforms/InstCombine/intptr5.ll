...
; CHECK-NEXT:    [[B_PHI:%.*]] = phi float* [ [[TMP0]], [[BB1]] ], [ [[BF:%.*]], [[BB2]] ]
...
; CHECK-NEXT:    [[B_ADDR_I64_PTR:%.*]] = phi float* [ [[B_ADDR_FLOAT_INC]], [[FOR_BODY]] ], [ [[B_PHI]], [[FOR_BODY_PREHEADER]] ], [ [[B_PHI]], [[FOR_BODY_PREHEADER]] ]
