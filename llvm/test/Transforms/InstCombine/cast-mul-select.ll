...
; CHECK-NEXT:    ]
; CHECK:       for.end:
; CHECK-NEXT:    [[H:%.*]] = phi i8 [ 0, [[FOR_BODY3]] ], [ 0, [[FOR_BODY3]] ], [ [[SPEC_SELECT]], [[FOR_BODY3_US]] ], [ [[SPEC_SELECT]], [[FOR_BODY3_US]] ]
...
; DBGINFO:       for.end:
; DBGINFO-NEXT:    [[H:%.*]] = phi i8 [ 0, [[FOR_BODY3]] ], [ 0, [[FOR_BODY3]] ], [ [[SPEC_SELECT]], [[FOR_BODY3_US]] ], [ [[SPEC_SELECT]], [[FOR_BODY3_US]] ], !dbg [[DBG100:![0-9]+]]
