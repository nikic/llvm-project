...
; CHECK-NEXT:    [[TMP4:%.*]] = select i1 [[TMP3]], i32 [[TMP2]], i32 32767
...
; CHECK-NEXT:    [[TMP1:%.*]] = add i32 [[X]], -32768
; CHECK-NEXT:    [[TMP2:%.*]] = icmp ult i32 [[TMP1]], -65536
; CHECK-NEXT:    [[R:%.*]] = select i1 [[TMP2]], i32 [[CLAMP_LIMIT]], i32 [[X]]
...
; CHECK-NEXT:    [[TMP3:%.*]] = select i1 [[TMP2]], i32 [[TMP1]], i32 32767
