...
; CHECK-NEXT:    [[T1:%.*]] = ptrtoint i32* [[A]] to i64, !dbg !9
...
; CHECK-NEXT:    [[ADD:%.*]] = add i8 [[X:%.*]], 1, !dbg !11
; CHECK-NEXT:    call void @llvm.assume(i1 false)
...
; CHECK-NEXT:    [[B12:%.*]] = lshr i32 -2147483648, [[AND1]], !dbg !13
; CHECK-NEXT:    [[C1:%.*]] = icmp ult i32 [[AND1]], [[B12]]
; CHECK-NEXT:    tail call void @llvm.assume(i1 [[C1]])
