...
; CHECK-V8M:       while.end:
; CHECK-V8M-NEXT:    [[TMP0:%.*]] = sub i32 -1, [[SIZE:%.*]]
; CHECK-V8M-NEXT:    [[UMAX:%.*]] = call i32 @llvm.umax.i32(i32 [[TMP0]], i32 -32)
; CHECK-V8M-NEXT:    [[TMP5:%.*]] = add i32 [[SIZE]], [[UMAX]]
; CHECK-V8M-NEXT:    [[TMP1:%.*]] = add i32 [[TMP5]], 32
...
; CHECK-V8A:       while.end:
; CHECK-V8A-NEXT:    [[TMP0:%.*]] = sub i32 -1, [[SIZE:%.*]]
; CHECK-V8A-NEXT:    [[UMAX:%.*]] = call i32 @llvm.umax.i32(i32 [[TMP0]], i32 -32)
; CHECK-V8A-NEXT:    [[TMP5:%.*]] = add i32 [[SIZE]], [[UMAX]]
; CHECK-V8A-NEXT:    [[TMP1:%.*]] = add i32 [[TMP5]], 32
