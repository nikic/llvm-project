...
; CHECK:       for.inc.us.us:
; CHECK-NEXT:    br i1 true, label [[FOR_INC_US_US]], label [[FOR_COND8_FOR_COND2_LOOPEXIT_CRIT_EDGE_US_US:%.*]]
...
; CHECK:       cond.end.us:
; CHECK-NEXT:    [[TMP5:%.*]] = load i32, i32* @b, align 4
; CHECK-NEXT:    [[CMP91_US:%.*]] = icmp slt i32 [[TMP5]], 1
; CHECK-NEXT:    br i1 [[CMP91_US]], label [[FOR_INC_LR_PH_US:%.*]], label [[FOR_COND2_LOOPEXIT_US:%.*]]
; CHECK:       for.inc.us:
; CHECK-NEXT:    br i1 true, label [[FOR_INC_US:%.*]], label [[FOR_COND8_FOR_COND2_LOOPEXIT_CRIT_EDGE_US:%.*]]
...
; CHECK-NEXT:    [[EXITCOND2:%.*]] = icmp ne i32 [[INDVARS_IV_NEXT]], 0
; CHECK-NEXT:    br i1 [[EXITCOND2]], label [[FOR_COND2_PREHEADER]], label [[FOR_END15:%.*]]
; CHECK:       for.end15:
; CHECK-NEXT:    ret void
;
