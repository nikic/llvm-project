...
; CHECK-NEXT:    [[NITER_NEXT_2:%.*]] = add nuw nsw i32 [[NITER]], 3
...
; CHECK-NEXT:    [[NITER_NEXT:%.*]] = add nuw nsw i32 [[NITER]], 1
; CHECK-NEXT:    [[INC5_1:%.*]] = add nuw nsw i32 [[INC5_SINK9]], 2
; CHECK-NEXT:    [[NITER_NEXT_1:%.*]] = add nuw nsw i32 [[NITER]], 2
; CHECK-NEXT:    [[INC5_2:%.*]] = add nuw nsw i32 [[INC5_SINK9]], 3
; CHECK-NEXT:    [[NITER_NEXT_2:%.*]] = add nuw nsw i32 [[NITER]], 3
...
; CHECK-NEXT:    [[INC25_1:%.*]] = add nuw nsw i64 [[STOREMERGE82]], 2
; CHECK-NEXT:    [[NITER_NEXT_1:%.*]] = add nuw nsw i64 [[NITER]], 2
; CHECK-NEXT:    [[INC25_2:%.*]] = add nuw nsw i64 [[STOREMERGE82]], 3
; CHECK-NEXT:    [[NITER_NEXT_2:%.*]] = add nuw nsw i64 [[NITER]], 3
