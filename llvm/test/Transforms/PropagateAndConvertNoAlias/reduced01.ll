...
for.cond:                                         ; preds = %for.cond, %entry
  ...
  %prov.h.1 = bitcast %struct.a* %prov.h.0 to i8*
  %.unpack = load i8, i8* %4, ptr_provenance i8* %prov.h.1, align 1, !noalias !2
...
; CHECK-NEXT:   %prov.h.1 = bitcast %struct.a* %prov.h.0 to i8*
; CHECK-NEXT:   %.unpack = load i8, i8* %4, ptr_provenance i8* %prov.h.1, align 1, !noalias !2
