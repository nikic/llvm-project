...
; CHECK-NEXT:    [[I8_1:%.*]] = add i64 [[I8]], 1
; CHECK-NEXT:    [[I8_2:%.*]] = add i64 [[I8_1]], 1
...
; CHECK:       bb6:
; CHECK-NEXT:    [[I7:%.*]] = phi i64 [ [[I7_UNR]], [[BB6_PREHEADER_NEW]] ], [ [[I8_7:%.*]], [[BB6]] ]
; CHECK-NEXT:    [[I8:%.*]] = add nuw nsw i64 [[I7]], 1
; CHECK-NEXT:    [[I8_1:%.*]] = add nuw nsw i64 [[I8]], 1
; CHECK-NEXT:    [[I8_2:%.*]] = add nuw nsw i64 [[I8_1]], 1
