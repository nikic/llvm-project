...
; RUN: opt < %s -loop-deletion -loop-deletion-enable-symbolic-execution -S | FileCheck %s
; RUN: opt < %s -passes='loop(loop-deletion)' -loop-deletion-enable-symbolic-execution -S | FileCheck %s
