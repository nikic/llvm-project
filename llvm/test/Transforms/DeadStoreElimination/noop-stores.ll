...
; conditional block. (A conditional block post dominates the branch
; inst.)
; does not dominate the conditional block.)
define void @remove_tautological_store_no_edge_domination(ptr %x) {
; CHECK-LABEL: @remove_tautological_store_edge_dominates(
; CHECK-NEXT:  entry:
