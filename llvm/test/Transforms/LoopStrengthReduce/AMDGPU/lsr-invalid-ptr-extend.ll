...
; CHECK-NEXT:    [[TMP0:%.*]] = add i32 [[LSR_IV_NEXT4]], -1
; CHECK-NEXT:    [[CONV:%.*]] = zext i32 [[TMP0]] to i64
; CHECK-NEXT:    br label [[FOR_BODY_1:%.*]]
; CHECK:       for.body.1:
; CHECK-NEXT:    [[LSR_IV1:%.*]] = phi i32 [ [[LSR_IV_NEXT2:%.*]], [[FOR_BODY_1]] ], [ [[LSR_IV_NEXT4_LCSSA]], [[LOOPEXIT:%.*]] ]
; CHECK-NEXT:    [[CONV_1:%.*]] = phi i64 [ [[CONV_2:%.*]], [[FOR_BODY_1]] ], [ [[CONV]], [[LOOPEXIT]] ]
; CHECK-NEXT:    [[IDXPROM:%.*]] = trunc i64 [[CONV_1]] to i32
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds ptr, ptr addrspace(5) null, i32 [[IDXPROM]]
; CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr addrspace(5) [[ARRAYIDX]], align 8
; CHECK-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds ptr, ptr null, i64 [[CONV_1]]
; CHECK-NEXT:    store ptr [[TMP1]], ptr [[ARRAYIDX_1]], align 8
; CHECK-NEXT:    [[CONV_2]] = zext i32 [[LSR_IV1]] to i64
