...
; CHECK-LINUX-NEXT:    b call1@notoc
; CHECK-LINUX-NEXT:    #TC_RETURNd8 call1@notoc 0
;
...
; CHECK-LINUX-32-NEXT:    stwu r1, -16(r1)
; CHECK-LINUX-32-NEXT:    .cfi_def_cfa_offset 16
; CHECK-LINUX-32-NEXT:    .cfi_offset lr, 4
; CHECK-LINUX-32-NEXT:    bl call1
; CHECK-LINUX-32-NEXT:    lwz r0, 20(r1)
; CHECK-LINUX-32-NEXT:    addi r1, r1, 16
...
; CHECK-AIX-32-NEXT:    stwu r1, -64(r1)
; CHECK-AIX-32-NEXT:    bl .call1[PR]
; CHECK-AIX-32-NEXT:    nop
; CHECK-AIX-32-NEXT:    addi r1, r1, 64
