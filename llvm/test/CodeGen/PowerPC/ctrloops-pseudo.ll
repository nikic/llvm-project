...
define i32 @test4(i32 %inp) {
  ...
  ; AIX64-NEXT:   [[COPY:%[0-9]+]]:g8rc = COPY $x3
  ; AIX64-NEXT:   [[COPY1:%[0-9]+]]:gprc = COPY [[COPY]].sub_32
  ; AIX64-NEXT:   [[NOR:%[0-9]+]]:gprc_and_gprc_nor0 = NOR [[COPY1]], [[COPY1]]
  ; AIX64-NEXT:   [[CMPWI:%[0-9]+]]:crrc = CMPWI [[COPY1]], 1
  ; AIX64-NEXT:   [[LI:%[0-9]+]]:gprc_and_gprc_nor0 = LI -2
  ...
  ; AIX64-NEXT:   successors: %bb.1(0x80000000)
  ; AIX64-NEXT: {{  $}}
  ; AIX64-NEXT:   [[PHI:%[0-9]+]]:gprc = PHI [[LI]], %bb.3, [[NOR]], %bb.0
  ; AIX64-NEXT:   [[NOR1:%[0-9]+]]:gprc = NOR [[PHI]], [[PHI]]
  ; AIX64-NEXT:   [[ADD4_:%[0-9]+]]:gprc_and_gprc_nor0 = ADD4 [[COPY1]], [[PHI]]
  ...
  ; AIX64-NEXT:   [[ADD4_1:%[0-9]+]]:gprc = ADD4 killed [[COPY2]], [[NOR1]]
  ; AIX64-NEXT:   [[DEF1:%[0-9]+]]:g8rc = IMPLICIT_DEF
  ; AIX64-NEXT:   [[INSERT_SUBREG1:%[0-9]+]]:g8rc = INSERT_SUBREG [[DEF1]], killed [[ADD4_1]], %subreg.sub_32
  ...
  ; AIX32-NEXT: {{  $}}
  ; AIX32-NEXT:   [[COPY:%[0-9]+]]:gprc = COPY $r3
  ; AIX32-NEXT:   [[NOR:%[0-9]+]]:gprc_and_gprc_nor0 = NOR [[COPY]], [[COPY]]
  ; AIX32-NEXT:   [[CMPWI:%[0-9]+]]:crrc = CMPWI [[COPY]], 1
  ; AIX32-NEXT:   [[LI:%[0-9]+]]:gprc_and_gprc_nor0 = LI -2
  ...
  ; AIX32-NEXT:   successors: %bb.1(0x80000000)
  ; AIX32-NEXT: {{  $}}
  ; AIX32-NEXT:   [[PHI:%[0-9]+]]:gprc = PHI [[LI]], %bb.3, [[NOR]], %bb.0
  ; AIX32-NEXT:   [[NOR1:%[0-9]+]]:gprc = NOR [[PHI]], [[PHI]]
  ; AIX32-NEXT:   [[ADD4_:%[0-9]+]]:gprc_and_gprc_nor0 = ADD4 [[COPY]], [[PHI]]
  ; AIX32-NEXT:   [[ADDI:%[0-9]+]]:gprc = ADDI killed [[ADD4_]], 2
  ...
  ; AIX32-NEXT:   [[ADD4_1:%[0-9]+]]:gprc = ADD4 killed [[TLSGDAIX]], [[NOR1]]
  ; AIX32-NEXT:   $r3 = COPY [[ADD4_1]]
  ...
  ; LE64-NEXT:   [[COPY:%[0-9]+]]:g8rc = COPY $x3
  ; LE64-NEXT:   [[COPY1:%[0-9]+]]:gprc = COPY [[COPY]].sub_32
  ; LE64-NEXT:   [[NOR:%[0-9]+]]:gprc_and_gprc_nor0 = NOR [[COPY1]], [[COPY1]]
  ; LE64-NEXT:   [[CMPWI:%[0-9]+]]:crrc = CMPWI [[COPY1]], 1
  ; LE64-NEXT:   [[LI:%[0-9]+]]:gprc_and_gprc_nor0 = LI -2
  ; LE64-NEXT:   [[ISEL:%[0-9]+]]:gprc = ISEL [[NOR]], [[LI]], [[CMPWI]].sub_lt
  ; LE64-NEXT:   [[NOR1:%[0-9]+]]:gprc = NOR [[ISEL]], [[ISEL]]
  ; LE64-NEXT:   [[ADD4_:%[0-9]+]]:gprc_and_gprc_nor0 = ADD4 [[COPY1]], [[ISEL]]
  ...
  ; LE64-NEXT:   [[ADD4_1:%[0-9]+]]:gprc = ADD4 killed [[COPY2]], [[NOR1]]
  ; LE64-NEXT:   [[DEF1:%[0-9]+]]:g8rc = IMPLICIT_DEF
  ; LE64-NEXT:   [[INSERT_SUBREG1:%[0-9]+]]:g8rc = INSERT_SUBREG [[DEF1]], killed [[ADD4_1]], %subreg.sub_32
