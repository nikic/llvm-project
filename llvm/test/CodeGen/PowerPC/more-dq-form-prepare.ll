...
; CHECK-NEXT:    ld 4, 864(1)
; CHECK-NEXT:    ld 2, 856(1)
; CHECK-NEXT:    mr 22, 5
...
; CHECK-NEXT:    ld 11, 728(1)
; CHECK-NEXT:    std 11, 80(1) # 8-byte Folded Spill
...
; CHECK-NEXT:    ld 4, 704(1)
; CHECK-NEXT:    ld 8, 32(1) # 8-byte Folded Reload
; CHECK-NEXT:    lxv 10, 0(21)
; CHECK-NEXT:    lxv 33, 0(11)
; CHECK-NEXT:    lxv 32, 0(15)
; CHECK-NEXT:    lxv 37, 0(16)
; CHECK-NEXT:    lxv 36, 0(17)
; CHECK-NEXT:    lxv 13, 0(18)
; CHECK-NEXT:    lxv 8, 0(24)
; CHECK-NEXT:    lxv 6, 0(25)
; CHECK-NEXT:    lxv 5, 0(26)
; CHECK-NEXT:    lxv 3, 0(27)
; CHECK-NEXT:    li 27, 0
; CHECK-NEXT:    mr 26, 22
; CHECK-NEXT:    std 4, 40(1) # 8-byte Folded Spill
; CHECK-NEXT:    sldi 4, 7, 3
; CHECK-NEXT:    ld 9, 48(1) # 8-byte Folded Reload
; CHECK-NEXT:    lxv 38, 0(8)
; CHECK-NEXT:    lxv 1, 0(28)
; CHECK-NEXT:    lxv 0, 0(29)
; CHECK-NEXT:    lxv 2, 0(12)
; CHECK-NEXT:    lxv 4, 0(30)
; CHECK-NEXT:    lxv 9, 0(2)
; CHECK-NEXT:    mulli 29, 7, 6
; CHECK-NEXT:    sldi 12, 7, 1
; CHECK-NEXT:    li 28, 1
; CHECK-NEXT:    ld 10, 40(1) # 8-byte Folded Reload
; CHECK-NEXT:    lxv 39, 0(9)
; CHECK-NEXT:    add 4, 4, 5
; CHECK-NEXT:    sldi 5, 7, 4
; CHECK-NEXT:    add 5, 5, 22
; CHECK-NEXT:    addi 14, 4, 32
; CHECK-NEXT:    mulli 4, 7, 48
; CHECK-NEXT:    addi 31, 5, 32
; CHECK-NEXT:    mulli 5, 7, 40
; CHECK-NEXT:    lxv 40, 0(10)
; CHECK-NEXT:    add 19, 22, 5
; CHECK-NEXT:    sldi 5, 7, 5
; CHECK-NEXT:    add 20, 22, 5
; CHECK-NEXT:    mulli 5, 7, 24
...
; CHECK-NEXT:    add 26, 26, 4
; CHECK-NEXT:    add 14, 14, 4
; CHECK-NEXT:    add 19, 19, 4
; CHECK-NEXT:    add 31, 31, 4
; CHECK-NEXT:    add 20, 20, 4
; CHECK-NEXT:    add 21, 21, 4
; CHECK-NEXT:    addi 27, 27, 1
; CHECK-NEXT:    cmpld 28, 0
