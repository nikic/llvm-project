...
; CHECK-NEXT:    vmlaldavax.s16 r6, r9, q0, q1
...
; CHECK-NEXT:    vmlaldavax.s16 r6, r9, q2, q3
; CHECK-NEXT:    vldrh.u16 q3, [r1, #-16]
; CHECK-NEXT:    vmlsldava.s16 r4, r7, q1, q0
; CHECK-NEXT:    vldrh.u16 q2, [r0, #-16]
; CHECK-NEXT:    vmlaldavax.s16 r6, r9, q1, q0
; CHECK-NEXT:    vldrh.u16 q1, [r0], #32
; CHECK-NEXT:    vmlsldava.s16 r4, r7, q2, q3
; CHECK-NEXT:    vldrh.u16 q0, [r1], #32
...
; CHECK-NEXT:  .LBB0_3:
; CHECK-NEXT:    vmlaldavax.s16 r6, r9, q2, q3
; CHECK-NEXT:    movs r5, #14
; CHECK-NEXT:    and.w r2, r5, r2, lsl #1
; CHECK-NEXT:    vmlaldavax.s16 r6, r9, q1, q0
; CHECK-NEXT:    vldrh.u16 q2, [r0, #-16]
; CHECK-NEXT:    vmlsldava.s16 r4, r7, q1, q0
; CHECK-NEXT:    vldrh.u16 q0, [r1, #-16]
; CHECK-NEXT:    vmlaldavax.s16 r6, r9, q2, q0
...
; CHECK-NEXT:    vmlaldavaxt.s16 r6, r9, q1, q0
...
; CHECK-NEXT:    vmlaldavaxt.s16 r6, r9, q0, q1
; CHECK-NEXT:    b .LBB0_9
; CHECK-NEXT:    .p2align 2
...
; CHECK-NEXT:    mov.w r9, #0
; CHECK-NEXT:    lsls r5, r2, #1
; CHECK-NEXT:    mov r6, r9
; CHECK-NEXT:    mov r4, r9
; CHECK-NEXT:    movs r7, #0
; CHECK-NEXT:    dlstp.16 lr, r5
; CHECK-NEXT:    .p2align 2
