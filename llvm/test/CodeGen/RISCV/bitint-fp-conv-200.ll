...
; RV64-NEXT:    addi a3, a0, -327
; RV64-NEXT:    li a4, -201
; RV64-NEXT:    bltu a4, a3, .LBB2_4
; RV64-NEXT:  # %bb.3: # %fp-to-i-if-then5
; RV64-NEXT:    srai a2, a2, 31
; RV64-NEXT:    not s1, a2
; RV64-NEXT:    xori a2, a2, 127
; RV64-NEXT:    mv s5, s1
; RV64-NEXT:    mv a0, s1
; RV64-NEXT:    j .LBB2_8
; RV64-NEXT:  .LBB2_4: # %fp-to-i-if-end9
; RV64-NEXT:    mv s7, a1
; RV64-NEXT:    srai s0, a2, 63
; RV64-NEXT:    slli a2, a2, 41
; RV64-NEXT:    lui a1, 2048
; RV64-NEXT:    li a3, 149
; RV64-NEXT:    srli a2, a2, 41
; RV64-NEXT:    or a1, a2, a1
; RV64-NEXT:    ori s2, s0, 1
; RV64-NEXT:    bltu a3, a0, .LBB2_6
...
; RV64-NEXT:    sltu a0, s4, a0
; RV64-NEXT:    add s6, a1, a0
; RV64-NEXT:    mv a0, s3
; RV64-NEXT:    li a1, 0
; RV64-NEXT:    mv a2, s0
; RV64-NEXT:    li a3, 0
; RV64-NEXT:    call __multi3
; RV64-NEXT:    add s5, a0, s4
; RV64-NEXT:    sltu a0, s5, a0
; RV64-NEXT:    add a0, a1, a0
; RV64-NEXT:    add s8, s6, a0
; RV64-NEXT:    li a0, 0
; RV64-NEXT:    li a1, 0
; RV64-NEXT:    mv a2, s0
; RV64-NEXT:    li a3, 0
...
; RV64-NEXT:    sltu a2, s9, s2
; RV64-NEXT:    sltu a3, s8, s6
; RV64-NEXT:    sltu a4, a0, s9
; RV64-NEXT:    add a3, s4, a3
; RV64-NEXT:    add a2, a3, a2
; RV64-NEXT:    add a1, a2, a1
; RV64-NEXT:    add a2, a1, a4
; RV64-NEXT:    j .LBB2_7
; RV64-NEXT:  .LBB2_6: # %fp-to-i-if-else
...
; RV64-NEXT:    call __multi3
; RV64-NEXT:    mv s1, a0
; RV64-NEXT:    add s2, s5, a1
; RV64-NEXT:    sltu a0, s2, s5
...
; RV64-NEXT:    li a3, 0
; RV64-NEXT:    call __multi3
; RV64-NEXT:    add s5, a0, s2
; RV64-NEXT:    sltu a0, s5, a0
; RV64-NEXT:    add a0, a1, a0
; RV64-NEXT:    add s2, s6, a0
; RV64-NEXT:    sltu s4, s2, s6
; RV64-NEXT:    mv a0, s3
; RV64-NEXT:    li a1, 0
; RV64-NEXT:    mv a2, s0
; RV64-NEXT:    li a3, 0
; RV64-NEXT:    call __multi3
; RV64-NEXT:    add a1, a1, s4
; RV64-NEXT:    add s2, a0, s2
; RV64-NEXT:    sltu a2, s2, a0
; RV64-NEXT:    add a0, s2, s8
; RV64-NEXT:    add a1, a1, a2
; RV64-NEXT:    add a1, a1, s9
; RV64-NEXT:    sltu a2, a0, s2
; RV64-NEXT:    add a2, a1, a2
; RV64-NEXT:  .LBB2_7: # %fp-to-i-cleanup
; RV64-NEXT:    mv a1, s7
; RV64-NEXT:  .LBB2_8: # %fp-to-i-cleanup
; RV64-NEXT:    sd s1, 0(a1)
; RV64-NEXT:    sd s5, 8(a1)
...
; RV32-NEXT:    li a4, -201
; RV32-NEXT:    bltu a4, a3, .LBB2_4
; RV32-NEXT:  # %bb.3: # %fp-to-i-if-then5
; RV32-NEXT:    srli a2, a2, 31
; RV32-NEXT:    addi s4, a2, -1
...
; RV32-NEXT:    sw a0, 144(sp) # 4-byte Folded Spill
; RV32-NEXT:    mv s1, a1
; RV32-NEXT:    li a0, 0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s2
...
; RV32-NEXT:    add s2, s5, s8
; RV32-NEXT:    add s9, a2, s9
; RV32-NEXT:    sltu s5, s2, s5
; RV32-NEXT:    add s9, s9, s5
; RV32-NEXT:    beq s9, a2, .LBB2_7
; RV32-NEXT:  # %bb.6: # %fp-to-i-if-then12
; RV32-NEXT:    sltu s5, s9, a2
; RV32-NEXT:  .LBB2_7: # %fp-to-i-if-then12
; RV32-NEXT:    sltu a3, s6, s3
; RV32-NEXT:    sltu a0, a2, a0
; RV32-NEXT:    add s6, s1, a3
; RV32-NEXT:    add a0, a1, a0
...
; RV32-NEXT:    mv a0, s0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    lw s4, 148(sp) # 4-byte Folded Reload
; RV32-NEXT:    mv a2, s4
; RV32-NEXT:    li a3, 0
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    mv s7, a1
; RV32-NEXT:    add s10, s5, a0
; RV32-NEXT:    sltu a0, s5, s11
; RV32-NEXT:    sltu a1, s11, s1
; RV32-NEXT:    sltu a2, s8, s6
; RV32-NEXT:    sltu s6, s10, s5
...
; RV32-NEXT:    add s11, s8, a2
; RV32-NEXT:    add s11, s11, s6
; RV32-NEXT:    beq s11, s8, .LBB2_9
; RV32-NEXT:  # %bb.8: # %fp-to-i-if-then12
; RV32-NEXT:    sltu s6, s11, s8
; RV32-NEXT:  .LBB2_9: # %fp-to-i-if-then12
; RV32-NEXT:    sltu a3, s5, s3
; RV32-NEXT:    sltu a0, a2, a0
; RV32-NEXT:    add s1, s1, a3
...
; RV32-NEXT:    lw s4, 144(sp) # 4-byte Folded Reload
; RV32-NEXT:    j .LBB2_23
; RV32-NEXT:  .LBB2_10: # %fp-to-i-if-else
...
; RV32-NEXT:    sw a5, 84(sp) # 4-byte Folded Spill
; RV32-NEXT:    sll a5, a5, a7
; RV32-NEXT:    sw a5, 120(sp) # 4-byte Folded Spill
...
; RV32-NEXT:    srl a0, a0, t0
; RV32-NEXT:    or s7, a3, a0
; RV32-NEXT:    sw a7, 100(sp) # 4-byte Folded Spill
; RV32-NEXT:    sll s9, a2, a7
; RV32-NEXT:    mv a0, s7
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s2
; RV32-NEXT:    li a3, 0
...
; RV32-NEXT:    sw s5, 128(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu a0, s5, a0
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    add s1, s3, a0
...
; RV32-NEXT:    add s11, s5, s11
; RV32-NEXT:    add s9, a2, s9
; RV32-NEXT:    sltu s5, s11, s5
; RV32-NEXT:    add s9, s9, s5
; RV32-NEXT:    beq s9, a2, .LBB2_12
; RV32-NEXT:  # %bb.11: # %fp-to-i-if-else
; RV32-NEXT:    sltu s5, s9, a2
; RV32-NEXT:  .LBB2_12: # %fp-to-i-if-else
; RV32-NEXT:    lw a3, 120(sp) # 4-byte Folded Reload
; RV32-NEXT:    lw a4, 116(sp) # 4-byte Folded Reload
...
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    add a2, a0, s6
; RV32-NEXT:    add s2, s8, s11
; RV32-NEXT:    sltu s1, s2, s8
; RV32-NEXT:    add a3, a2, s1
; RV32-NEXT:    add s9, a3, s9
; RV32-NEXT:    beq s9, a2, .LBB2_14
; RV32-NEXT:  # %bb.13: # %fp-to-i-if-else
; RV32-NEXT:    sltu s1, s9, a2
; RV32-NEXT:  .LBB2_14: # %fp-to-i-if-else
; RV32-NEXT:    sltu a3, s6, s7
; RV32-NEXT:    sltu a0, a2, a0
; RV32-NEXT:    add a3, s5, a3
; RV32-NEXT:    sw a3, 60(sp) # 4-byte Folded Spill
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    add s11, a3, a0
; RV32-NEXT:    lw a0, 148(sp) # 4-byte Folded Reload
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s0
; RV32-NEXT:    li a3, 0
...
; RV32-NEXT:    sltu a2, s6, a3
; RV32-NEXT:    sltu a3, s7, s8
; RV32-NEXT:    lw a4, 60(sp) # 4-byte Folded Reload
; RV32-NEXT:    sltu a4, s11, a4
; RV32-NEXT:    sltu a5, s8, s10
; RV32-NEXT:    add s10, s5, s1
; RV32-NEXT:    lw a6, 108(sp) # 4-byte Folded Reload
; RV32-NEXT:    add a1, a6, a1
; RV32-NEXT:    lw a6, 56(sp) # 4-byte Folded Reload
; RV32-NEXT:    add a4, a6, a4
; RV32-NEXT:    sltu s11, s10, s5
; RV32-NEXT:    add a0, a1, a0
...
; RV32-NEXT:    sltu s1, s5, a0
; RV32-NEXT:    add s6, s8, s1
; RV32-NEXT:    sw s3, 52(sp) # 4-byte Folded Spill
; RV32-NEXT:    add s6, s6, s3
; RV32-NEXT:    mv a0, s0
; RV32-NEXT:    li a1, 0
...
; RV32-NEXT:    add a0, a0, a1
; RV32-NEXT:    sw s5, 76(sp) # 4-byte Folded Spill
...
; RV32-NEXT:    sltu a1, s8, a1
; RV32-NEXT:    lw s8, 56(sp) # 4-byte Folded Reload
...
; RV32-NEXT:    lw s7, 116(sp) # 4-byte Folded Reload
; RV32-NEXT:    mv a1, s7
; RV32-NEXT:    mv a2, s0
; RV32-NEXT:    mv a3, s0
; RV32-NEXT:    call __muldi3
...
; RV32-NEXT:    add s3, s3, a0
; RV32-NEXT:    mv s6, s5
; RV32-NEXT:    lw s5, 32(sp) # 4-byte Folded Reload
; RV32-NEXT:    add s5, s5, a1
; RV32-NEXT:    mv a0, s0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s7
...
; RV32-NEXT:    lw s7, 148(sp) # 4-byte Folded Reload
; RV32-NEXT:    mv a1, s7
; RV32-NEXT:    lw a2, 132(sp) # 4-byte Folded Reload
; RV32-NEXT:    call __muldi3
...
; RV32-NEXT:    sltu a1, a2, a1
; RV32-NEXT:    lw s5, 80(sp) # 4-byte Folded Reload
; RV32-NEXT:    add s5, s5, a0
; RV32-NEXT:    lw s6, 72(sp) # 4-byte Folded Reload
...
; RV32-NEXT:    lw a1, 136(sp) # 4-byte Folded Reload
; RV32-NEXT:    lw a2, 128(sp) # 4-byte Folded Reload
; RV32-NEXT:  .LBB2_23: # %fp-to-i-cleanup
; RV32-NEXT:    sw s4, 0(a1)
; RV32-NEXT:    sw a2, 4(a1)
; RV32-NEXT:    sw s2, 8(a1)
; RV32-NEXT:    sw s9, 12(a1)
; RV32-NEXT:    sw s10, 16(a1)
; RV32-NEXT:    sw s11, 20(a1)
