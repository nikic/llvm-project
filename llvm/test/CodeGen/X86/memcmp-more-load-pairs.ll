...
; X64-NEXT:    cmpq %rdx, %rcx
; X64-NEXT:    je .LBB35_2
; X64-NEXT:  .LBB35_3: # %res_block
; X64-NEXT:    xorl %eax, %eax
; X64-NEXT:    cmpq %rdx, %rcx
; X64-NEXT:    sbbl %eax, %eax
; X64-NEXT:    orl $1, %eax
; X64-NEXT:  .LBB35_2: # %endblock
; X64-NEXT:    shrl $31, %eax
; X64-NEXT:    # kill: def $al killed $al killed $eax
; X64-NEXT:    retq
  %call = tail call i32 @memcmp(ptr %x, ptr %y, i64 16) nounwind
...
; X64-NEXT:    cmpq %rdx, %rcx
; X64-NEXT:    jne .LBB38_1
; X64-NEXT:  # %bb.4: # %endblock
; X64-NEXT:    retq
; X64-NEXT:  .LBB38_1: # %res_block
; X64-NEXT:    xorl %eax, %eax
; X64-NEXT:    cmpq %rdx, %rcx
; X64-NEXT:    sbbl %eax, %eax
; X64-NEXT:    orl $1, %eax
...
; X64-NEXT:    cmpq %rdx, %rcx
; X64-NEXT:    je .LBB45_4
; X64-NEXT:  .LBB45_5: # %res_block
; X64-NEXT:    xorl %eax, %eax
; X64-NEXT:    cmpq %rdx, %rcx
; X64-NEXT:    sbbl %eax, %eax
; X64-NEXT:    orl $1, %eax
; X64-NEXT:  .LBB45_4: # %endblock
; X64-NEXT:    shrl $31, %eax
; X64-NEXT:    # kill: def $al killed $al killed $eax
; X64-NEXT:    retq
  %call = tail call i32 @memcmp(ptr %x, ptr %y, i64 31) nounwind
...
; X64-NEXT:    cmpq %rdx, %rcx
; X64-NEXT:    je .LBB51_4
; X64-NEXT:  .LBB51_5: # %res_block
; X64-NEXT:    xorl %eax, %eax
; X64-NEXT:    cmpq %rdx, %rcx
; X64-NEXT:    sbbl %eax, %eax
; X64-NEXT:    orl $1, %eax
; X64-NEXT:  .LBB51_4: # %endblock
; X64-NEXT:    shrl $31, %eax
; X64-NEXT:    # kill: def $al killed $al killed $eax
; X64-NEXT:    retq
  %call = tail call i32 @memcmp(ptr %x, ptr %y, i64 32) nounwind
