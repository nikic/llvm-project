...
define void @foo(i32 %M, i32 %N, i32 %K, ptr %A, ptr %B_rcr4, ptr %C, i32 %c_row_from, i32 %c_row_to, i32 %c_row_tile, i32 %c_col_from, i32 %c_col_to, i32 %c_col_tile) {
  ...
  ; CHECK-NEXT:   [[AND32ri:%[0-9]+]]:gr32 = AND32ri [[AND32ri]], -64, implicit-def dead $eflags
  ...
  ; CHECK-NEXT:   [[SUB32rr:%[0-9]+]]:gr32 = SUB32rr [[SUB32rr]], [[AND32ri]], implicit-def dead $eflags
  ...
  ; CHECK-NEXT:   %83.sub_32bit:gr64_with_sub_8bit = SUB32rr %83.sub_32bit, [[SUB32rr]], implicit-def dead $eflags
  ...
  ; CHECK-NEXT:   [[COPY16:%[0-9]+]]:gr32 = COPY [[COPY5]]
  ...
  ; CHECK-NEXT:   [[PTDPBSSDV:%[0-9]+]]:tile = PTDPBSSDV [[COPY16]].sub_16bit, [[COPY18]].sub_16bit, [[COPY16]].sub_16bit, [[PTDPBSSDV]], [[PTILELOADDV]], [[PTILELOADDV1]]
