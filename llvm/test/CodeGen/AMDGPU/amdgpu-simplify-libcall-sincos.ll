...
; CHECK-SAME: (half [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,2)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,2)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<2 x half> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (half [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,2)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,2)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<3 x half> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,8)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,8)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<4 x half> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,8)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,8)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<8 x half> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,16)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,16)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<16 x half> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,32)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,32)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (float [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR3:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<2 x float> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,8)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,8)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (float [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR3]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[__SINCOS_:%.*]] = alloca float, align 4, addrspace(5)
...
; CHECK-SAME: (<3 x float> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,16)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,16)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<4 x float> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,16)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,16)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<8 x float> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,32)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,32)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<16 x float> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,64)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,64)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (double [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,8)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,8)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<2 x double> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,16)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,16)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<3 x double> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,32)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,32)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<4 x double> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,32)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,32)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<8 x double> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,64)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,64)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (<16 x double> [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,128)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,128)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (i1 [[COND:%.*]], float [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]], ptr addrspace(1) nocapture writeonly [[OTHER:%.*]]) local_unnamed_addr #[[ATTR3]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[__SINCOS_:%.*]] = alloca float, align 4, addrspace(5)
; CHECK-NEXT:    [[TMP0:%.*]] = call contract float @_Z6sincosfPU3AS5f(float [[X]], ptr addrspace(5) [[__SINCOS_]])
; CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr addrspace(5) [[__SINCOS_]], align 4
...
; CHECK-SAME: (i1 [[COND:%.*]], float [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]], ptr addrspace(1) nocapture readnone [[OTHER:%.*]]) local_unnamed_addr #[[ATTR3]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[__SINCOS_:%.*]] = alloca float, align 4, addrspace(5)
; CHECK-NEXT:    [[TMP0:%.*]] = call contract float @_Z6sincosfPU3AS5f(float [[X]], ptr addrspace(5) [[__SINCOS_]])
; CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr addrspace(5) [[__SINCOS_]], align 4
...
; CHECK-SAME: (ptr addrspace(1) [[VALUE_PTR:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[__SINCOS_:%.*]] = alloca float, align 4, addrspace(5)
...
; CHECK-SAME: (ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR3]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[__SINCOS_:%.*]] = alloca float, align 4, addrspace(5)
...
; CHECK-SAME: (ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (float [[X:%.*]], float [[Y:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR2]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (float [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]], ptr nocapture readonly [[FUNC_PTR:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[CALL:%.*]] = tail call contract float @_Z3sinf(float [[X]])
; CHECK-NEXT:    store float [[CALL]], ptr addrspace(1) [[SIN_OUT]], align 4
...
; CHECK-SAME: (float [[X:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR3]] !dbg [[DBG7:![0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-SAME: (float [[X:%.*]], ptr addrspace(1) nocapture readnone [[SIN_OUT:%.*]], ptr addrspace(1) nocapture writeonly initialized((0,4)) [[COS_OUT:%.*]]) local_unnamed_addr #[[ATTR3]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[COS_TMP:%.*]] = alloca float, align 4, addrspace(5)
