...
; GFX10-NEXT:    s_load_dword s4, s[0:1], 0x3c
...
; GFX10-NEXT:    ds_write_b8 v0, v1 offset:4
; GFX10-NEXT:    ds_write_b8_d16_hi v0, v1 offset:6
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_clause 0x2
; GFX10-NEXT:    s_load_dword s4, s[0:1], 0x24
; GFX10-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x34
...
; GFX10-NEXT:    ds_write_b16_d16_hi v0, v1 offset:6
; GFX10-NEXT:    ds_write_b16 v0, v2
; GFX10-NEXT:    ds_write_b16_d16_hi v0, v2 offset:2
; GFX10-NEXT:    ds_write_b16 v0, v3 offset:8
; GFX10-NEXT:    ds_write_b16_d16_hi v0, v3 offset:10
; GFX10-NEXT:    s_endpgm
