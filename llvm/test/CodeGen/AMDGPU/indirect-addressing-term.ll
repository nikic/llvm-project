...
define amdgpu_kernel void @extract_w_offset_vgpr(i32 addrspace(1)* %out) {
  ...
  ; GCN-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 36, 0 :: (invariant load (s64) from %ir.out.kernarg.offset.cast, align 4, addrspace 4)
