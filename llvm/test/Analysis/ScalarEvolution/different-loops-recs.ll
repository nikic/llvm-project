...
; CHECK-NEXT:  -->  {{{{}}130,+,3}<nuw><nsw><%loop1>,+,3}<nw><%loop2>
; CHECK:       %s4 = add i32 %sum4, %sum2
; CHECK-NEXT:  -->  {{{{}}179,+,6}<nuw><nsw><%loop1>,+,6}<nw><%loop2>
; CHECK:       %s5 = add i32 %phi3, %sum3
; CHECK-NEXT:  -->  {{{{}}122,+,3}<nuw><nsw><%loop1>,+,3}<nw><%loop2>
; CHECK:       %s6 = add i32 %sum2, %phi6
; CHECK-NEXT:  -->  {{{{}}63,+,6}<nuw><nsw><%loop1>,+,3}<nw><%loop2>
...
; CHECK-NEXT:  -->  {{{{}}(159 + (2 * %b)),+,2}<%loop1>,+,6}<nw><%loop2>
