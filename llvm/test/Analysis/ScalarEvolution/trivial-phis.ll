...
; CHECK-NEXT: --> {1,+,1}<%bb13> U: [1,9223372036854775807) S: [1,9223372036854775807) Exits: (-2 + %arg) LoopDispositions: { %bb13: Computable, %bb8: Variant, %bb17: Invariant, %bb27: Invariant }
