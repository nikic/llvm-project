...
; CHECK-NEXT:    --> {%n,+,-1}<nsw><%for.body> U: [-2147483647,-2147483648) S: [-2147483647,-2147483648) Exits: 0 LoopDispositions: { %for.body: Computable }
; CHECK-NEXT:    %dec = add nsw i32 %i.011, -1
; CHECK-NEXT:    --> {(-1 + %n),+,-1}<nsw><%for.body> U: [-2147483648,2147483647) S: [-2147483648,2147483647) Exits: -1 LoopDispositions: { %for.body: Computable }
