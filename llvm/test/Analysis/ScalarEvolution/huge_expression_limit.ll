...
; CHECK-NEXT:    --> (%b + %a) U: full-set S: full-set
; CHECK-NEXT:    %add2 = add i32 %add1, %c
; CHECK-NEXT:    --> ((%b + %a) + %c) U: full-set S: full-set
; CHECK-NEXT:    %add3 = add i32 %add2, %d
; CHECK-NEXT:    --> (((%b + %a) + %c) + %d) U: full-set S: full-set
; CHECK-NEXT:    %add4 = add i32 %add3, %e
; CHECK-NEXT:    --> ((((%b + %a) + %c) + %d) + %e) U: full-set S: full-set
; CHECK-NEXT:    %add5 = add i32 %add4, %f
; CHECK-NEXT:    --> (((((%b + %a) + %c) + %d) + %e) + %f) U: full-set S: full-set
