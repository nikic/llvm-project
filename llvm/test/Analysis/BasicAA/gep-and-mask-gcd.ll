...
; Without boost: GCD=3, ModOffset=2 mod 3=2, but 3-2=1 < 2 (i16). MayAlias.
; With boost: TZContrib=|3|<<1=6, GCD=6, ModOffset=2 mod 6=2, 6-2=4>=2. NoAlias.
