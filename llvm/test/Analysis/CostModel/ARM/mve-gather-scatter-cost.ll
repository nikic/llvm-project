...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep1 = getelementptr i32, ptr %base, <4 x i32> %ind32
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep2 = getelementptr i32, ptr %base, <4 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep3 = getelementptr i32, ptr %base, <4 x i32> %indsext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gepu = getelementptr i32, ptr %base, <4 x i32> %ind32
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gepos = getelementptr i8, ptr %base8, <4 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gepbs = getelementptr i16, ptr %base16, <4 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep1 = getelementptr i16, ptr %base, <4 x i32> %ind32
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %indzext = zext <4 x i16> %ind16 to <4 x i32>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep2 = getelementptr i16, ptr %base, <4 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %indsext = sext <4 x i16> %ind16 to <4 x i32>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep3 = getelementptr i16, ptr %base, <4 x i32> %indsext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep5 = getelementptr i16, ptr %base, <4 x i16> %ind16
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep5 = getelementptr i8, ptr %base, <4 x i8> %ind8
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep1 = getelementptr i16, ptr %base, <8 x i32> %ind32
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep2 = getelementptr i16, ptr %base, <8 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep3 = getelementptr i16, ptr %base, <8 x i32> %indsext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gepos = getelementptr i8, ptr %base8, <8 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gepbs = getelementptr i32, ptr %base32, <8 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep4 = getelementptr i16, ptr %base, <8 x i32> %indzext4
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep5 = getelementptr i8, ptr %base, <8 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep1 = getelementptr i8, ptr %base, <16 x i32> %ind32
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep2 = getelementptr i8, ptr %base, <16 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gep3 = getelementptr i8, ptr %base, <16 x i32> %indsext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gepbs = getelementptr i16, ptr %base16, <16 x i32> %indzext
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %gepbs = getelementptr i8, <16 x ptr> %base, i32 %off
