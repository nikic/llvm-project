...
void DataLayout::reset(StringRef Desc) {
  ...
  // Default alignments
  for (const auto &P : DefaultAlignments) {
    if (Error Err = setAlignment(P.first, P.second.ABIAlign,
                                 P.second.PrefAlign, P.second.TypeBitWidth))
...
SmallVectorImpl<LayoutAlignElem>::const_iterator
