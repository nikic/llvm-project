...
StructLayout::StructLayout(StructType *ST, const DataLayout &DL)
  ...
  for (unsigned i = 0, e = NumElements; i != e; ++i) {
    ...
    // have members of the same data type so no alignment issue will happen.
    // The condition here assumes so and needs to be adjusted if this assumption
    // changes (e.g. we support structures with arbitrary scalable data type, or
    // structure that contains both fixed size and scalable size data type
    // members).
