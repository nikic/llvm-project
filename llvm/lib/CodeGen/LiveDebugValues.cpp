...
struct LocIndex {
  ...
  /// A special location reserved for VarLocs of kind EntryValueKind,
  /// EntryValueBackupKind, and EntryValueCopyBackupKind.
  static constexpr uint32_t kEntryValueLocation = kFirstInvalidRegLocation + 1;
...
private:
  ...
  class VarLocMap {
    ...
    static uint32_t getLocationForVar(const VarLoc &VL) {
      ...
      case VarLoc::EntryValueCopyBackupKind:
        return LocIndex::kEntryValueLocation;
      default:
        return 0;
      }
    }
  ...
  public:
    ...
    /// Get all set IDs for VarLocs of kind EntryValueKind,
    /// EntryValueBackupKind, or EntryValueCopyBackupKind.
    auto getEntryValueVarLocs() const {
      return LocIndex::indexRangeForLocation(getVarLocs(),
                                             LocIndex::kEntryValueLocation);
    }
  };
