...
void SmallPtrSetImplBase::CopyFrom(const void **SmallStorage, const SmallPtrSetImplBase &RHS) {
...
void SmallPtrSetImplBase::swap(const void **SmallStorage,
  ...
  std::swap_ranges(this->CurArray, this->CurArray + MinNonEmpty,
                   RHS.CurArray);
  if (this->NumNonEmpty > MinNonEmpty) {
    std::copy(this->CurArray + MinNonEmpty,
              this->CurArray + this->NumNonEmpty,
