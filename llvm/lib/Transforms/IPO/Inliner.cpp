          ...
          if (NewCallee) {
            if (!NewCallee->isDeclaration()) {
              ...
              if (CalleeSCC != C &&
                ...
                int ICBCostMultiplier = getStringFnAttrAsInt(*ICB, InlineConstants::FunctionInlineCostMultiplierAttributeName).getValueOr(1);
                Attribute NewCBCostMult = Attribute::get(
                    M.getContext(),
                    InlineConstants::FunctionInlineCostMultiplierAttributeName,
                    itostr(CBCostMult * ICBCostMultiplier * IntraSCCCostMultiplier));
