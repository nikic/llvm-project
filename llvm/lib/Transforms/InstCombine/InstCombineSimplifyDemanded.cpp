...
Value *InstCombinerImpl::SimplifyDemandedUseBits(Value *V, APInt DemandedMask,
  ...
  case Instruction::URem: {
    ...
    SimplifyQuery NewQ = SQ.getWithInstruction(I);
    if (SimplifyDemandedBits(I, 0, AllOnes, LHSKnown, Depth + 1, NewQ) ||
        SimplifyDemandedBits(I, 1, AllOnes, RHSKnown, Depth + 1, NewQ))
      return I;
