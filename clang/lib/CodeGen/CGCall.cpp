...
//       CoercedType = getReverseMapper().convertType(AbiInfo.getCoerceToType());
//     if (!CoercedType)
//       CoercedType = ConvertType(type);
//
//     llvm::Type *PaddingType = nullptr;
//     if (AbiInfo.getPaddingType())
//       PaddingType = getReverseMapper().convertType(AbiInfo.getPaddingType());
//
...
//
//     if (AbiInfo.getCoerceToType())
//       CoerceType = getReverseMapper().convertType(AbiInfo.getCoerceToType());
//     if (AbiInfo.getUnpaddedCoerceAndExpandType())
//       UnpaddedType =
//           getReverseMapper().convertType(AbiInfo.getUnpaddedCoerceAndExpandType());
//
//     if (!CoerceType)
