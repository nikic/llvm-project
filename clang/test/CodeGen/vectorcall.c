...
// X86: define dso_local x86_vectorcallcc void @"\01hva7@@0"(ptr inreg noalias nocapture sret(%struct.HVA5) align 16 %agg.result)
// X64: define dso_local x86_vectorcallcc void @"\01hva7@@0"(ptr noalias nocapture sret(%struct.HVA5) align 16 %agg.result)
