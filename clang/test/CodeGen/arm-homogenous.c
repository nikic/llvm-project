...
// CHECK: declare arm_aapcs_vfpcc void @returns_union_with_first_floats(ptr nocapture sret(%union.union_with_first_floats) align 4)
...
// CHECK: declare arm_aapcs_vfpcc void @returns_union_with_non_first_floats(ptr nocapture sret(%union.union_with_non_first_floats) align 4)
...
// CHECK: declare arm_aapcs_vfpcc void @returns_struct_with_union_with_first_floats(ptr nocapture sret(%struct.struct_with_union_with_first_floats) align 4)
...
// CHECK: declare arm_aapcs_vfpcc void @returns_struct_with_union_with_non_first_floats(ptr nocapture sret(%struct.struct_with_union_with_non_first_floats) align 4)
