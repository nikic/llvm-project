...
__attribute__((ms_abi)) struct i128 f7(struct i128 a) {
  // WIN64: define dso_local void @f7(ptr noalias nocapture sret(%struct.i128) align 8 %agg.result, ptr noundef %a)
  // FREEBSD: define{{.*}} win64cc void @f7(ptr noalias nocapture sret(%struct.i128) align 8 %agg.result, ptr noundef %a)
  return a;
}
