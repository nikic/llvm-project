...
//
// N64-LABEL: define{{.*}} void @foo5(ptr noalias nocapture sret(%struct.S0) align 16 %agg.result, i64 %0, fp128 noundef %a0)
// N64: call void @foo6(ptr nocapture sret(%struct.S0) align 16 %agg.result, i32 noundef signext 1, i32 noundef signext 2, i64 undef, fp128 noundef %a0)
// N64: declare void @foo6(ptr nocapture sret(%struct.S0) align 16, i32 noundef signext, i32 noundef signext, i64, fp128 noundef)
