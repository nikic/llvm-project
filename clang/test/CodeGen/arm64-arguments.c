...
// CHECK: define{{.*}} void @f1_2(ptr noalias nocapture sret(<8 x float>) align 16 %{{.*}}, ptr noundef %0)
T_float32x8 f1_2(T_float32x8 a0) { return a0; }
// CHECK: define{{.*}} void @f1_3(ptr noalias nocapture sret(<16 x float>) align 16 %{{.*}}, ptr noundef %0)
