...
// CHECK: define{{.*}} void @f_ret_double_double_s(ptr noalias nocapture sret(%struct.double_double_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_double_float_s(ptr noalias nocapture sret(%struct.double_float_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_double_int8_s(ptr noalias nocapture sret(%struct.double_int8_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_double_uint8_s(ptr noalias nocapture sret(%struct.double_uint8_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_double_int32_s(ptr noalias nocapture sret(%struct.double_int32_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_double_int64_s(ptr noalias nocapture sret(%struct.double_int64_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_double_int64bf_s(ptr noalias nocapture sret(%struct.double_int64bf_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_double_int8_zbf_s(ptr noalias nocapture sret(%struct.double_int8_zbf_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_doublecomplex(ptr noalias nocapture sret({ double, double }) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_doublecomplex_s(ptr noalias nocapture sret(%struct.doublecomplex_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_doublearr2_s(ptr noalias nocapture sret(%struct.doublearr2_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_doublearr2_tricky1_s(ptr noalias nocapture sret(%struct.doublearr2_tricky1_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_doublearr2_tricky2_s(ptr noalias nocapture sret(%struct.doublearr2_tricky2_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_doublearr2_tricky3_s(ptr noalias nocapture sret(%struct.doublearr2_tricky3_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_doublearr2_tricky4_s(ptr noalias nocapture sret(%struct.doublearr2_tricky4_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_int_double_int_s(ptr noalias nocapture sret(%struct.int_double_int_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_int64_double_s(ptr noalias nocapture sret(%struct.int64_double_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_char_char_double_s(ptr noalias nocapture sret(%struct.char_char_double_s) align 4 %agg.result)
...
// CHECK: define{{.*}} void @f_ret_double_int32_s_double_int32_s_just_sufficient_gprs(ptr noalias nocapture sret(%struct.double_int32_s) align 4 %agg.result, i32 noundef %a, i32 noundef %b, i32 noundef %c, i32 noundef %d, i32 noundef %e, i32 noundef %f, i32 noundef %g, [3 x i32] %h.coerce)
...
// CHECK: define{{.*}} void @f_ret_double_double_s_double_int32_s_just_sufficient_gprs(ptr noalias nocapture sret(%struct.double_double_s) align 4 %agg.result, i32 noundef %a, i32 noundef %b, i32 noundef %c, i32 noundef %d, i32 noundef %e, i32 noundef %f, i32 noundef %g, [3 x i32] %h.coerce)
struct double_double_s f_ret_double_double_s_double_int32_s_just_sufficient_gprs(
    int a, int b, int c, int d, int e, int f, int g, struct double_int32_s h) {
  return (struct double_double_s){1.0, 2.0};
}

// CHECK: define{{.*}} void @f_ret_doublecomplex_double_int32_s_just_sufficient_gprs(ptr noalias nocapture sret({ double, double }) align 4 %agg.result, i32 noundef %a, i32 noundef %b, i32 noundef %c, i32 noundef %d, i32 noundef %e, i32 noundef %f, i32 noundef %g, [3 x i32] %h.coerce)
...
// CHECK-LABEL: define{{.*}} void @f_scalar_stack_2(ptr noalias nocapture sret(%struct.large) align 4 %agg.result, float noundef %a, i64 noundef %b, double noundef %c, double noundef %d, i8 noundef zeroext %e, i8 noundef signext %f, i8 noundef zeroext %g)
