...
// CHECK-SOFT: define{{.*}} void @_Z2f12S1(ptr noalias nocapture writeonly nocapture sret(%struct.S1) align 8 %agg.result, [2 x i64] %s1.coerce)
...
// CHECK-SOFT: define{{.*}} void @_Z2f22S2(ptr noalias nocapture writeonly nocapture sret(%struct.S2) align 8 %agg.result, [4 x i32] %s2.coerce)
...
// CHECK-SOFT: define{{.*}} void @_Z2f32S3(ptr noalias nocapture writeonly nocapture sret(%struct.S3) align 8 %agg.result, [2 x i64] %s3.coerce)
...
// CHECK-SOFT: define{{.*}} void @_Z2f42S4(ptr noalias nocapture writeonly nocapture sret(%struct.S4) align 8 %agg.result, [2 x i64] %s4.coerce)
...
// CHECK-SOFT: define{{.*}} void @_Z2f52S5(ptr noalias nocapture writeonly nocapture sret(%struct.S5) align 8 %agg.result, [2 x i64] %s5.coerce)
