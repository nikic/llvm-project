...
// O32-LABEL: define{{.*}} void @test_v4sf(ptr noalias nocapture writeonly nocapture sret
// N64: define{{.*}} inreg { i64, i64 } @test_v4sf
v4sf test_v4sf(float a) {
  return (v4sf){0.0f, a, 0.0f, 0.0f};
}

// O32-LABEL: define{{.*}} void @test_v4df(ptr noalias nocapture writeonly nocapture sret
// N64-LABEL: define{{.*}} void @test_v4df(ptr noalias nocapture writeonly nocapture sret
