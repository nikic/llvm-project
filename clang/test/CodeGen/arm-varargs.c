...
// CHECK-LABEL: define{{.*}} void @simple_struct(ptr noalias nocapture sret(%struct.bigstruct) align 4 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @simple_aligned_struct(ptr noalias nocapture sret(%struct.aligned_bigstruct) align 8 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @simple_hfa(ptr noalias nocapture sret(%struct.hfa) align 4 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @overaligned_int_struct_test(ptr noalias nocapture sret(%struct.overaligned_int_struct) align 16 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @underaligned_long_long_struct_test(ptr noalias nocapture sret(%struct.underaligned_long_long_struct) align 2 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @overaligned_long_long_struct_test(ptr noalias nocapture sret(%struct.overaligned_long_long_struct) align 16 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @overaligned_int_struct_member_test(ptr noalias nocapture sret(%struct.overaligned_int_struct_member) align 16 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @underaligned_long_long_struct_member_test(ptr noalias nocapture sret(%struct.underaligned_long_long_struct_member) align 2 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @overaligned_long_long_struct_member_test(ptr noalias nocapture sret(%struct.overaligned_long_long_struct_member) align 16 %agg.result)
