...
// APCS-GNU: ptr noalias nocapture sret
...
// AAPCS: define{{.*}} arm_aapcscc void @f24({{.*}} noalias nocapture sret
// AAPCS: define{{.*}} arm_aapcscc void @f25({{.*}} noalias nocapture sret
// AAPCS: define{{.*}} arm_aapcscc void @f26({{.*}} noalias nocapture sret
// AAPCS: define{{.*}} arm_aapcscc void @f27({{.*}} noalias nocapture sret
...
// APCS-GNU: define{{.*}} void @f30({{.*}} noalias nocapture sret
// AAPCS: define{{.*}} arm_aapcscc void @f30({{.*}} noalias nocapture sret
