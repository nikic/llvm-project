...
// CHECK: define{{.*}} void @func_f9(ptr noalias nocapture sret(%struct.fp9) align 16 %agg.result, ptr noundef byval(%struct.fp9) align 16 %x)
...
// CHECK: call void @func_f9(ptr nocapture sret(%struct.fp9) align 16 %[[TMP2:[^ ]+]], ptr noundef byval(%struct.fp9) align 16 @global_f9
