...
// CHECK: define{{.*}} void @test_v16i16(ptr noalias nocapture sret(<16 x i16>) align 32 %agg.result, ptr noundef %0)
v16i16 test_v16i16(v16i16 x)
{
  return x;
}

// CHECK: define{{.*}} void @test_struct_v16i16(ptr noalias nocapture sret(%struct.v16i16) align 32 %agg.result, [2 x i128] %x.coerce)
