...
// CHECK-BE-LABEL: define{{.*}} void @_Z20pass_agg_float_class15agg_float_class(ptr noalias nocapture sret(%class.agg_float_class) align 4 %{{.*}}, float inreg %{{.*}})
...
// CHECK-BE-LABEL: define{{.*}} void @_Z21pass_agg_double_class16agg_double_class(ptr noalias nocapture sret(%class.agg_double_class) align 8 %{{.*}}, double inreg %{{.*}})
...
// CHECK-BE-LABEL: define{{.*}} void @_Z18pass_agg_float_cpp13agg_float_cpp(ptr noalias nocapture sret(%struct.agg_float_cpp) align 4 %{{.*}}, float inreg %{{.*}})
...
// CHECK-BE-LABEL: define{{.*}} void @_Z22pass_agg_nofloat_empty17agg_nofloat_empty(ptr noalias nocapture sret(%struct.agg_nofloat_empty) align 4 %{{.*}}, i64 %{{.*}})
...
// CHECK-BE-LABEL: define{{.*}} void @_Z20pass_agg_float_empty15agg_float_empty(ptr noalias nocapture sret(%struct.agg_float_empty) align 4 %{{.*}}, float inreg %{{.*}})
...
// CHECK-BE-LABEL: define{{.*}} void @_Z27pass_agg_nofloat_emptyarray22agg_nofloat_emptyarray(ptr noalias nocapture sret(%struct.agg_nofloat_emptyarray) align 4 %{{.*}}, i64 %{{.*}})
...
// CHECK-BE-LABEL: define{{.*}} void @_Z26pass_agg_nofloat_emptybase21agg_nofloat_emptybase(ptr noalias nocapture sret(%struct.agg_nofloat_emptybase) align 4 %{{.*}}, i64 %{{.*}})
...
// CHECK-BE-LABEL: define{{.*}} void @_Z24pass_agg_float_emptybase19agg_float_emptybase(ptr noalias nocapture sret(%struct.agg_float_emptybase) align 4 %{{.*}}, float inreg %{{.*}})
...
// CHECK-BE-LABEL: define{{.*}} void @_Z31pass_agg_nofloat_emptybasearray26agg_nofloat_emptybasearray(ptr noalias nocapture sret(%struct.agg_nofloat_emptybasearray) align 4 %{{.*}}, i64 %{{.*}})
...
// CHECK-BE: call void @_Z24pass_agg_float_emptybase19agg_float_emptybase(ptr nocapture sret(%struct.agg_float_emptybase) align 4 %{{.*}}, float inreg %{{.*}})
...
// CHECK-BE: call void @_Z26pass_agg_nofloat_emptybase21agg_nofloat_emptybase(ptr nocapture sret(%struct.agg_nofloat_emptybase) align 4 %{{.*}}, i64 %{{.*}})
