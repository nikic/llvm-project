...
// CHECK-RS32: void @retShortCharShort(ptr noalias nocapture sret(%struct.sShortCharShort) align 2 %agg.result)
// CHECK-RS64: [3 x i16] @retShortCharShort()
sShortCharShort retShortCharShort(void) { sShortCharShort r; return r; }

// CHECK-RS32: void @retIntShortChar(ptr noalias nocapture sret(%struct.sIntShortChar) align 4 %agg.result)
// CHECK-RS64: [2 x i32] @retIntShortChar()
sIntShortChar retIntShortChar(void) { sIntShortChar r; return r; }

// CHECK-RS32: void @retLongInt(ptr noalias nocapture sret(%struct.sLongInt) align 8 %agg.result)
...
// CHECK-RS32: void @retInt5(ptr noalias nocapture sret(%struct.sInt5) align 4 %agg.result)
// CHECK-RS64: void @retInt5(ptr noalias nocapture sret(%struct.sInt5) align 4 %agg.result)
sInt5 retInt5(void) { sInt5 r; return r;}

// CHECK-RS32: void @retLong2Char(ptr noalias nocapture sret(%struct.sLong2Char) align 8 %agg.result)
// CHECK-RS64: void @retLong2Char(ptr noalias nocapture sret(%struct.sLong2Char) align 8 %agg.result)
...
// CHECK-RS32: void @retLong9(ptr noalias nocapture sret(%struct.sLong9) align 8 %agg.result)
// CHECK-RS64: void @retLong9(ptr noalias nocapture sret(%struct.sLong9) align 8 %agg.result)
