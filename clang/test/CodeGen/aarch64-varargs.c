...
// CHECK-LABEL: define{{.*}} void @overaligned_int128_struct_test(ptr noalias nocapture sret(%struct.overaligned_int128_struct) align 32 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @overaligned_int128_struct_member_test(ptr noalias nocapture sret(%struct.overaligned_int128_struct_member) align 32 %agg.result)
