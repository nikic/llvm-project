...
// CHECK-SAME: (i32 noundef [[NUM:%.*]], ptr nocapture noundef writeonly initialized((0,8)) [[VEC:%.*]], ptr nocapture noundef readonly [[INDEX:%.*]], ptr nocapture noundef readonly [[ARR:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
// CHECK-NEXT:  entry:
