...
// CHECK: i32 @f11()
// CHECK: void @f12(ptr noalias nocapture sret(<2 x i32>) align 8 %agg.result)
// CHECK: i64 @f13()
// CHECK: i64 @f14()
// CHECK: <2 x i64> @f15()
// CHECK: <2 x i64> @f16()
...
// CHECK: i32 @f17()
// CHECK: void @f18(ptr noalias nocapture sret(%struct.anon.{{[0-9]+}}) align 8 %agg.result)
// CHECK: void @f19(ptr noalias nocapture sret(%struct.anon.{{[0-9]+}}) align 8 %agg.result)
// CHECK: void @f20(ptr noalias nocapture sret(%struct.anon.{{[0-9]+}}) align 8 %agg.result)
// CHECK: void @f21(ptr noalias nocapture sret(%struct.anon.{{[0-9]+}}) align 16 %agg.result)
// CHECK: void @f22(ptr noalias nocapture sret(%struct.anon.{{[0-9]+}}) align 16 %agg.result)
...
// CHECK: i32 @f26()
// CHECK: void @f27(ptr noalias nocapture sret(%struct.s27) align 1 %agg.result)
...
// CHECK: void @f28(ptr noalias nocapture sret(%struct.s28) align 4 %agg.result)
...
// CHECK-LABEL: define{{.*}} void @f38(ptr noalias nocapture sret(%struct.s38) align 2 %agg.result)
