...
// CHECK-LABEL: define{{.*}} void @retLargeStruct(ptr noalias nocapture sret(%struct.st12_t) align 4 %agg.result, i32 noundef %i1, ptr noundef byval(%struct.st12_t) align 4 %r)
