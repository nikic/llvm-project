...
// CHECK-LABEL: define dso_local void @"?f@@YA?AUA@@XZ"(ptr noalias nocapture sret(%struct.A) align 1 %agg.result)
// CHECK: call void @__dyn_tls_on_demand_init()
// CHECK-LD-LABEL: define dso_local void @"?f@@YA?AUA@@XZ"(ptr noalias nocapture sret(%struct.A) align 1 %agg.result)
