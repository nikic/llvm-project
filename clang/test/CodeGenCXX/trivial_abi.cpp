...
// CHECK: define{{.*}} void @_Z15testReturnLargev(ptr noalias nocapture sret(%[[STRUCT_LARGE]]) align 8 %[[AGG_RESULT:.*]])
...
// CHECK: %[[AGG_TMP:.*]] = alloca %[[STRUCT_LARGE:.*]], align 8
// CHECK: call void @_Z15testReturnLargev(ptr nocapture sret(%[[STRUCT_LARGE]]) align 8 %[[AGG_TMP]])
// CHECK: call void @_Z14testParamLarge5Large(ptr noundef %[[AGG_TMP]])
// CHECK: ret void
// CHECK: }
...
// CHECK: call void @_Z15testReturnLargev(ptr nocapture sret(%[[STRUCT_LARGE]]) align 8 %[[AGG_TMP_ENSURED]])
...
// CHECK: define{{.*}} void @_Z23testReturnHasNonTrivialv(ptr noalias nocapture sret(%[[STRUCT_NONTRIVIAL:.*]]) align 4 %[[AGG_RESULT:.*]])
