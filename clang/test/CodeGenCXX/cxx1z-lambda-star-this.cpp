...
//CHECK: @"?foo@A@@QAE?A?<auto>@@XZ"(ptr {{[^,]*}} %this, ptr noalias nocapture sret(%class.anon) align 8 %[[A_LAMBDA_RETVAL:.*]])
...
//CHECK: @"?bar@B@@QAE?A?<auto>@@XZ"(ptr {{[^,]*}} %this, ptr noalias nocapture sret(%class.anon.0) align 4 %agg.result)
