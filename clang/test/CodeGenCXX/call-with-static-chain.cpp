...
void test() {
  ...
  // CHECK32: call void @f2(ptr nocapture sret(%struct.B) align 4 %{{[0-9a-z]+}}, ptr nest noundef @f2)
  // CHECK64: call void @f2(ptr nocapture sret(%struct.B) align 8 %{{[0-9a-z]+}}, ptr nest noundef @f2)
