...
// CHECK-LABEL: define linkonce_odr void @_ZThn4_N1C1fEv(ptr noalias nocapture sret({ i32, i32 }) align 4 %agg.result, ptr noundef %this)
// CHECK: tail call void @_ZN1C1fEv(ptr nocapture sret({ i32, i32 }) align 4 %agg.result
