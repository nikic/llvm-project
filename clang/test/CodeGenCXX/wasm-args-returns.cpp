...
test(two_fields);
// CHECK: define void @_Z7forward10two_fields(ptr noalias nocapture writeonly nocapture sret(%struct.two_fields) align 8 %{{.*}}, ptr nocapture readonly byval(%struct.two_fields) align 8 %{{.*}})
//
// CHECK: define void @_Z15test_two_fieldsv()
// CHECK: %[[tmp:.*]] = alloca %struct.two_fields, align 8
// CHECK: call void @_Z14def_two_fieldsv(ptr nonnull nocapture sret(%struct.two_fields) align 8 %[[tmp]])
...
// CHECK: declare void @_Z14def_two_fieldsv(ptr nocapture sret(%struct.two_fields) align 8)
...
test(copy_ctor);
// CHECK: define void @_Z7forward9copy_ctor(ptr noalias {{[^,]*}} nocapture sret(%struct.copy_ctor) align 8 %{{.*}}, ptr nonnull %{{.*}})
//
...
// CHECK: call void @_Z13def_copy_ctorv(ptr nonnull nocapture sret(%struct.copy_ctor) align 8 %[[tmp]])
// CHECK: call void @_Z3use9copy_ctor(ptr nonnull %[[tmp]])
// CHECK: ret void
//
// CHECK: declare void @_Z3use9copy_ctor(ptr)
// CHECK: declare void @_Z13def_copy_ctorv(ptr nocapture sret(%struct.copy_ctor) align 8)
...
// CHECK: define void @_Z7forward17aligned_copy_ctor(ptr noalias {{[^,]*}} nocapture sret(%struct.aligned_copy_ctor) align 16 %{{.*}}, ptr nonnull %{{.*}})
//
...
// CHECK: call void @_Z21def_aligned_copy_ctorv(ptr nonnull nocapture sret(%struct.aligned_copy_ctor) align 16 %[[tmp]])
// CHECK: call void @_Z3use17aligned_copy_ctor(ptr nonnull %[[tmp]])
// CHECK: ret void
//
// CHECK: declare void @_Z3use17aligned_copy_ctor(ptr)
// CHECK: declare void @_Z21def_aligned_copy_ctorv(ptr nocapture sret(%struct.aligned_copy_ctor) align 16)
