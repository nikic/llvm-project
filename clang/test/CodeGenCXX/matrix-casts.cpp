...
Foo class_constructor_matrix_ty(matrix_5_5<int> m) {
  // CHECK-LABEL: define void @_Z27class_constructor_matrix_tyu11matrix_typeILm5ELm5EiE(%class.Foo* noalias nocapture sret(%class.Foo) align 4 %agg.result, <25 x i32> noundef %m)
...
Bar struct_constructor_matrix_ty(matrix_4_4<float> m) {
  // CHECK-LABEL: define void @_Z28struct_constructor_matrix_tyu11matrix_typeILm4ELm4EfE(%struct.Bar* noalias nocapture sret(%struct.Bar) align 4 %agg.result, <16 x float> noundef %m)
