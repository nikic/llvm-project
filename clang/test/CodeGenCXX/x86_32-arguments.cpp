...
// CHECK-LABEL: define{{.*}} void @_Z1fv(ptr noalias nocapture sret(%struct.S) align 2 %
S f() { return S(); }
...
// CHECK-LABEL: define{{.*}} void @_Z1gv(ptr noalias nocapture sret(%class.C) align 4 %
C g() { return C(); }
...
// CHECK-LABEL: define{{.*}} void @_Z2f8v(ptr noalias nocapture sret(%struct.s8) align 4 %agg.result)
struct s8_0 { };
struct s8_1 { double x; };
struct s8 { s8_0 a; s8_1 b; };
s8 f8() { return s8(); }

// CHECK-LABEL: define{{.*}} void @_Z2f9v(ptr noalias nocapture sret(%struct.s9) align 4 %agg.result)
