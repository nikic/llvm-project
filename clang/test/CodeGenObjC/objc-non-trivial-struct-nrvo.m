...
// CHECK: define{{.*}} void @testTrivialBig(ptr noalias nocapture sret(%[[STRUCT_TRIVIALBIG]]) align 4 %[[AGG_RESULT:.*]])
...
// CHECK: define{{.*}} void @testWeak(ptr noalias nocapture sret(%[[STRUCT_WEAK]]) align 8 %[[AGG_RESULT:.*]])
// CHECK: %[[NRVO:.*]] = alloca i1, align 1
...
// CHECK: define internal void @"\01-[C1 foo1]"(ptr noalias nocapture sret(%[[STRUCT_WEAK]]) align 8 %[[AGG_RESULT:.*]], ptr noundef %{{.*}}, ptr noundef %{{.*}})
// CHECK: %[[NRVO:.*]] = alloca i1, align 1
// CHECK: call void @__default_constructor_8_w0(ptr %[[AGG_RESULT]])
// CHECK: store i1 true, ptr %[[NRVO]], align 1
// CHECK: %[[NRVO_VAL:.*]] = load i1, ptr %[[NRVO]], align 1
