...
extern "C" void f1(int) {
  ...
  // CHECK: %[[FRAME:.+]] = call ptr @llvm.coro.begin(
  co_yield 42;
  // CHECK: call void @_ZNSt16coroutine_traitsIJviEE12promise_type11yield_valueEi(ptr nocapture sret(%struct.suspend_maybe) align 4 %[[AWAITER:.+]], ptr {{[^,]*}} %[[PROMISE]], i32 42)
...
extern "C" void TestAggr() {
  ...
  Whatever();
  // CHECK: call void @_ZN11AggrAwaiter12await_resumeEv(ptr nocapture sret(%struct.Aggr) align 4 %[[AwaitResume:.+]],
  ...
  Whatever();
  // CHECK: call void @_ZN11AggrAwaiter12await_resumeEv(ptr nocapture sret(%struct.Aggr) align 4 %[[AwaitResume2:.+]],
  // CHECK: call void @_ZN4AggrD1Ev(ptr {{[^,]*}} %[[AwaitResume2]])
  // CHECK: call void @Whatever()

  Aggr Val = co_await AggrAwaiter{};
  Whatever();
  // CHECK: call void @_ZN11AggrAwaiter12await_resumeEv(ptr nocapture sret(%struct.Aggr) align 4 %[[AwaitResume3:.+]],
  // CHECK: call void @Whatever()
...
extern "C" void TestOpAwait() {
  ...
  // CHECK: call void @_ZN11AggrAwaiter12await_resumeEv(ptr nocapture sret(%struct.Aggr) align 4 %
}
