...
// CHECK-NEXT:    call void @_ZN7MyRange5beginEv(ptr nocapture sret([[STRUCT_MYITERATOR]]) align 1 [[__BEGIN2]], ptr noundef nonnull align 1 dereferenceable(1) [[TMP0]])
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[__RANGE2]], align 8
// CHECK-NEXT:    call void @_ZN7MyRange3endEv(ptr nocapture sret([[STRUCT_MYITERATOR]]) align 1 [[__END2]], ptr noundef nonnull align 1 dereferenceable(1) [[TMP1]])
...
// CHECK-NEXT:    call void @_ZNK10MyIteratorplEj(ptr nocapture sret([[STRUCT_MYITERATOR]]) align 1 [[REF_TMP]], ptr noundef nonnull align 1 dereferenceable(1) [[TMP1]], i32 noundef [[CONV]])
