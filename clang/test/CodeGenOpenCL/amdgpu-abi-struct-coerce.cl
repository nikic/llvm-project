...
// CHECK: define{{.*}} void @func_ret_struct_arr32(ptr addrspace(5) noalias nocapture writeonly nocapture sret(%struct.struct_arr32) align 4 %agg.result)
...
// CHECK: define{{.*}} void @func_ret_struct_arr33(ptr addrspace(5) noalias nocapture writeonly nocapture sret(%struct.struct_arr33) align 4 %agg.result)
...
// CHECK: define{{.*}} void @func_flexible_array_ret(ptr addrspace(5) noalias nocapture writeonly nocapture sret(%struct.flexible_array) align 4 %agg.result)
